...
def update_list_of_cells(red_cells: List[Cell], green_cells: List[Cell]) -> Tuple[List[Cell]]:
    """Given a list of red_cells and green_cells, does the following:
        For each red_cell:
            - if it is verified, moves it to green_cells,
            - if it is unverified, splits that cell.
        """
    new_red_cells = []
